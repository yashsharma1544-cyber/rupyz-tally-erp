...
export default async function AreaReportPage({
  ...
  if (rows.length === 0) return <ErrorPanel message="No data for this area in the selected JC." />;
    ...
    <div className="max-w-6xl mx-auto p-4 space-y-5">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="text-xs text-ink-muted flex items-center gap-1 flex-wrap">
          ...
          <span>/</span>
          <span className="text-ink font-medium">{areaName}</span>
        </div>
      </div>
      ...
      <div className="bg-paper-card border border-paper-line rounded-md overflow-hidden">
        <div className="px-4 py-3 border-b border-paper-line font-semibold text-sm">Performance by Beat</div>
